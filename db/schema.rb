...
ActiveRecord::Schema.define(version: 20160411222129) do
  ...
  add_index "contacts_files", ["user_id"], name: "index_contacts_files_on_user_id", using: :btree
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "readed",          default: [], array: true
    t.integer  "user_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer  "contacts_users_count",   default: 0
    t.integer  "documents_count",        default: 0
    t.integer  "contacts_files_count",   default: 0
